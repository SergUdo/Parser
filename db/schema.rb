...
ActiveRecord::Schema.define(version: 2019_05_14_084313) do
  ...
  create_table "merchants", force: :cascade do |t|
    ...
    t.float "latitude"
    t.float "longitude"
    t.index ["address", "name"], name: "index_merchants_on_address_and_name", unique: true
  end
  ...
  create_table "merchants_lists", force: :cascade do |t|
    ...
    t.integer "city_column"
    t.integer "kind_column"
    t.integer "owner_column"
